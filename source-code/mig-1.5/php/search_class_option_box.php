...
<form>
<p>
<select size="1" name="class" ONCHANGE="if (this.options[this.selectedIndex].value != '' != 0) { page = '<?php echo $SCRIPT_NAME ?>?<?php echo SID ?>&class=' + this.options[this.selectedIndex].value; window.open(page,'_self') }">  
