...
<form>
<p>
<select size="1" name="group" ONCHANGE="if (this.options[this.selectedIndex].value != '') {	page = '<?php echo $SCRIPT_NAME ?>?<?php echo SID ?>&group=' + this.options[this.selectedIndex].value; window.open(page,'_self') }">  
