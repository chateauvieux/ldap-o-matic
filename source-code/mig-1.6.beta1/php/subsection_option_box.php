...
<form>
<p>
<select size="1" name="subsection" ONCHANGE="if (this.options[this.selectedIndex].value != '') { page = '<?php echo $_SERVER["SCRIPT_NAME"] ?>?<?php echo SID ?>&subsection=' + this.options[this.selectedIndex].value + '&class=<?php echo $class ?>'; window.open(page,'_self') }">  
